...
namespace bot
{
	namespace firmware
	{
			...
			public protocol::MessageReplyCallback
		{
			private:
				/* pool de objetos. */
				friend class base::ObjectPool<NotificationSender, POOLSIZE_bot_firmware_NotificationSender>;
				static base::ObjectPool<NotificationSender, POOLSIZE_bot_firmware_NotificationSender> m_pool;

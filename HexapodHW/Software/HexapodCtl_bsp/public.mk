...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../TesteNIOS.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Teste_SOPC.sopcinfo
...
# setting BSP_SYS_LIB is freertos_bsp
BSP_SYS_LIB := freertos_bsp
ELF_PATCH_FLAG  += --thread_model freertos

# Type identifier of the BSP library 
# setting BSP_TYPE is freertos
...
# Design Name 
# setting SOPC_NAME is Teste_SOPC
SOPC_NAME := Teste_SOPC
...
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/FreeRTOS/inc/
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/FreeRTOS/Source/include
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/FreeRTOS/Source/portable/GCC/NiosII
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/FreeRTOS/Source/

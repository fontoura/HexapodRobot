-- cpu_altera_nios_custom_instr_floating_point_inst.vhd
...
entity cpu_altera_nios_custom_instr_floating_point_inst is
	port (
...
end entity cpu_altera_nios_custom_instr_floating_point_inst;

architecture rtl of cpu_altera_nios_custom_instr_floating_point_inst is
...
begin
	...
	cpu_altera_nios_custom_instr_floating_point_inst : component fpoint_wrapper
		generic map (
			useDivider => 1
		)
		port map (
...
end architecture rtl; -- of cpu_altera_nios_custom_instr_floating_point_inst
